               ...
               <div class="container">
                  <div class="row d_flex">
                     <div class=" col-xl-8 col-lg-8 col-md-8 col-12-9">
                        <div class="text-bg">
                           <h1>Amai Bread<br> <span class="white1">High Quality</span></h1>
               ...
               <div class="col-md-12">
                  <div class="our_two_box">
                     <div class="row d_flex">
                           ...
                           <div class="our_img">
                              <figure><img src="image/5.jpg" alt="#"/></figure>
                           </div>
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                           <div class="our_text_box">
                              <h3 class="awesome pa_wi">The Best ingridients</h3>
                              ...
                              <div class="post_box padding_bottom1">
                                 <h4 class="flot_left1">Post By : Bara </h4>
                                 <ul class="like">
               ...
               <div class="col-md-12">
                  <div class="our_two_box">
                     <div class="row">
                        <div class="col-md-12">
                           <div class="our_img">
                              <figure><img class="he_img" src="image/1.jpg" alt="#" style="width: 1240px;"/></figure>
                          
                         
                           <div class="our_text_box position_box">
                              <h3 class="awesome withi_color">This Bread so Beautiful display </h3>
                              ...
                              <div class="post_box">
                                 <h4 class="flot_left1 withi_color">Post By : AMAI </h4>
             ...
             <!-- three section -->
                     <div class="row">
                         <div class="col-md-6 padding_bottom2">
                           <div class="our_img">
                              <figure><img src="image/1.jpg" alt="#"/></figure>
                           </div>
                           <div class="our_text_box three_box">
                              
                              
                              <div class="post_box d_flex padding_top3">
                                 <h3 class="awesome padding_flot">Bread 1</h3>
                                 <h4 class="flot_left1">Post By : Bara </h4>
                        ...
                        <div class="col-md-6">
                           <div class="our_img">
                              <figure><img src="image/4.jpg" alt="#"/></figure>
                           </div>
                           <div class="our_text_box three_box">
                             
                              
                              <div class="post_box d_flex padding_top3">
                                  <h3 class="awesome padding_flot">Bread 2</h3>
                                 <h4 class="flot_left1">Post By : Bara </h4>
                                 <ul class="like padding_left2">
                                    <li><a href="#"><img src="images/like.png" alt="#"/>Like</a></li>
                                     <li><a href="#"><img src="images/comm.png" alt="#"/>Comment</a></li>
               ...
               <div class="col-md-12">
                  <div class="our_two_box magna_top90">
                     <div class="row d_flex">
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                           <div class="our_text_box">
                              <h3 class="awesome pa_wi">Our Bread Quick is comment </h3>
